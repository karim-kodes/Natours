...
exports.signUp = catchAsync(async (req, res, next) => {
  ...
  // Instead of using createSendToken here, we can directly use signToken
  // to generate the token and then use it in the response.
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  if (!email || !password) {
    return next(
      new AppError("Please provide the correct email or password", 400)
    );
  }
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 3. Update changedPasswordAt property for the user (handled in pre-save middleware)
